...
INSERT INTO `articles` (`id_article`, `title_main`, `resume`, `name_image_main`, `grade`, `opinion`, `date_creation`, `date_modification`) VALUES
(1, 'L’arrêt de Juul en France ?', 'Effectivement la Start-Up Juul (Californienne) a déclarée leurs motivations à arrêter la commercialisations de leurs produits au sein de l’Europe,', '247-2479508_juul-logo-png.png', NULL, NULL, DATE(NOW()), NULL),
(2, 'Aspire – Nautilus 2S', 'Dans la famille Nautilus je demande le 2S, La marque Aspire a revu son Nautilus pour une utilisation plus simple.', 'nautlius-2s-banniere.png', 8, 'Dans l’ensemble, c’est un Nautilus comme les autres. Un très bon tirage serré qui délivre de très bonne saveur. Ce qui me ferais vous le conseiller est vraiment son nouveau système de remplissage qui facilite la vie. Hormis ça, pas de réelles avancées. La vap indirect de qualité qu’on connait des Nautilus, et des résistances de qualitée. Les saveurs sont les et les fuites inexistantes.', DATE('2020-02-01'), DATE('2020-03-25')),
(3, 'Geek Vape – Aegis Solo 100W', 'Voilà la petite soeur de l’Aegis Legend ! Dite aussi indestructible … Nous allons voir ça.', 'famille aegis.PNG', 10, 'Geek vape sait encore une fois séduire avec cette petite bombe ! Petite et pratique elle pourra vous suivre dans votre vie de tous les jours sans avoir peur de la faire tomber ou la mouiller ! Plutôt un bon point si vous chercher une box pour vos allday. Effectivement cette box me suit tous les jours avec mon petit Siren V2 mtl, malgré l’autonomie de la batterie qui ne me satisfait pas totalement sa robustesse me séduit, je suis quelqu’un qui ne fait pas forcément toujours attention à ses affaires… je peux donc avoir l’esprit tranquille avec l’Aegis Solo 100W.', DATE('2020-02-25'), NULL),
(4, 'OFRF – Gear RTA', 'The French Vapoteur a testé le Gear RTA, un atomiseur reconstructible de chez OFRF. Une marque inconnu au bataillons, mais', 'photo-gear-endessous.png', 7, 'Cela fait deux mois que je le teste… Que dire… Peut importe le liquide que j’utilise, il est embellie, c’est un exhausteur de saveur ! Que ce soit du gourmand, du fruité ou des liquides mentholés ils ressortent tous mieux que comme je les connaissais. Si vous rechercher un atomiseur saveur, vous trouverez votre bonheur avec le Gear.', DATE('2019-12-12'), NULL);
